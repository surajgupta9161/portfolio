        ...
        <div className='about-sections'>
          ...
          <div className='about-right'>
            <div className='about-para'>
              <p>
                My name is Suraj, and I am a Computer Science Engineer with a
                B.Tech degree. I have a strong interest in coding,
                problem-solving, and technology development. I enjoy exploring
                new programming languages, building projects, and improving my
                technical skills. My goal is to grow as a developer and
                contribute to creating innovative software solutions.
              </p>
            </div>
            <div className='about-skills'>
              ...
              <div className='about-skill'>
                <p>Tailwind CSS</p> <hr style={{ width: '80%' }} />
              </div>
              <div className='about-skill'>
